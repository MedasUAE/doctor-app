...
export class AppointmentsPage {
  ...
  getSlots(date){
    ...
    this.http.post("v2/doc-appoint", {"doctor_id":doctor_id,"appoint_date":date})
      .then((result:any)=>{
        this.slots = result.list;
  ...
  fabClick(){
    (this.dashboardFlag) ? this.dashboardFlag = false : this.dashboardFlag = true;
  }
